...
public class OptionsControlEditor : Editor {
	...
	public SerializedProperty panelsOptions;		// list
	public SerializedProperty buttons;				// list
	...
	// AMOUNTS TEXT LIST
	public SerializedProperty amounts; 		// list
	ReorderableList amounts2;

	// SLIDERS TEXT LIST
	public SerializedProperty sliders; 		// list
	ReorderableList sliders2;

	// DROPDOWNS TEXT LIST
	public SerializedProperty dropdowns; 	// list
	ReorderableList dropdowns2;

	// TOGGLES TEXT LIST
	public SerializedProperty toggles; 		// list
	ReorderableList toggles2;

	// RESOLUTIONS TEXT LIST
	public SerializedProperty resolutions; 	// list
